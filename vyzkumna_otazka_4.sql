...
SELECT
	...
	price_table.price_change,
	payroll_table.payroll_change,
	price_table.price_change - payroll_table.payroll_change AS difference
FROM(
...
SELECT 
	...
	ROUND(((avg_price_per_year-avg_price_previous_year)/avg_price_previous_year)*100,2) AS price_change
...
SELECT 
	...
	ROUND(((avg_payroll-avg_payroll_previous_year)/avg_payroll_previous_year)*100,2) AS payroll_change
